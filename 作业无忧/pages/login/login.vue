...
import protocol from "../../static/text/protocol.js";
...
export default {
  ...
  data() {
    ...
    return {
      ...
      policyText: protocol.policyText(),
      agreeProtocol: uni.getStorageSync("agreeProtocol"),
      imgInfo: {
        head: isUni
          ? "/static/login-reg/head.png"
          : require("./images/head.png"),
        icon_user: isUni
          ? "/static/login-reg/icon_user.png"
          : require("./images/icon_user.png"),
        icon_del: isUni
          ? "/static/login-reg/icon_del.png"
          : require("./images/icon_del.png"),
        icon_pwd: isUni
          ? "/static/login-reg/icon_pwd.png"
          : require("./images/icon_pwd.png"),
        icon_pwd_switch: isUni
          ? "/static/login-reg/icon_pwd_switch.png"
          : require("./images/icon_pwd_switch.png"),
        qq: isUni ? "/static/login-reg/qq.png" : require("./images/qq.png"),
        wechat: isUni
          ? "/static/login-reg/wechat.png"
          : require("./images/wechat.png"),
        weibo: isUni
          ? "/static/login-reg/weibo.png"
          : require("./images/weibo.png"),
      },
    };
  },
  onBackPress() {
