  ...
  <view>
    <form>
      <view class="cu-form-group margin-top" @click="changeAvatar">
        ...
        <view
          class="cu-avatar radius bg-gray"
          :style="'backgroung-image:url(' + avatar + ')'"
        >
          <image
      ...
      <view class="bottom">
        <span class="path" hover-class="navigator-hover" @tap="showProtocol(0)"
          >《服务协议》</span
        >
        |
        <span class="path" hover-class="navigator-hover" @tap="showProtocol(1)"
          >《隐私政策》</span
        >
      </view>
    </form>
